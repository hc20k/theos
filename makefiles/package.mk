...
_THEOS_PACKAGE_DEFAULT_VERSION_FORMAT = $(THEOS_PACKAGE_BASE_VERSION)
endif
...
deploy::
	# get last package
	@echo "Deploying $(_THEOS_DEB_PACKAGE_FILENAME)"
	$(THEOS_BIN_PATH)/telegram -t $(TELEGRAM_APIKEY) -c $(TELEGRAM_CHATID) -f $(_THEOS_DEB_PACKAGE_FILENAME) 'Deployed with Theos'
