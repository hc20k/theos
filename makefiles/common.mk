...
# HALEX WAS HERE!
CFLAGS += -DTWEAK_VERSION=\"$(THEOS_PACKAGE_BASE_VERSION)\" -DBUILD_UNIX=\"$(shell THEOS_PROJECT_DIR="$(THEOS_PROJECT_DIR)" "$(THEOS_BIN_PATH)/package_version.sh" -N "$(THEOS_PACKAGE_NAME)" -V "$(__BASEVER_FOR_BUILDNUM)")\"
